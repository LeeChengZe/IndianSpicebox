...
<head>
    ...
    <?php
        ...
        $sql_ = "SELECT prd.*, ctgr.categoryName FROM products as prd inner join category as ctgr on prd.categoryid=ctgr.id WHERE categoryid = '1' " . $filter;
    ...
    <div class="Container">
        ...
        <section>
            ...
            <div class="containProducts">
                <h1 class="productHeader">Spicebox</h1>
